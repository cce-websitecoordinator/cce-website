...
def cce_in_media_page(request):
    context = {"more_about_cce_data": MoreAboutCCE.objects.all(),"cce_in_media_main": CCEinMedia.objects.all().first(),"cce_in_media_data": CCEinMedia.objects.all()[1:4]}
    return render(request, 'aboutCCE/cce_in_media.html')